      ...
      const savePredictionPoints = await userCollection.bulkWrite([
        //Update all 0 point predictions
        {
          updateMany: {
            ...
            arrayFilters: [{ "tournament.tournament_id": mongo.Types.ObjectId(result.tournament_id) }, { "prediction.game_id": mongo.Types.ObjectId(result._id), "prediction.winner": { $ne: winner } }],
          },
        },
        ...
        //Update all 1 point predictions
        {
          updateMany: {
            ...
            arrayFilters: [{ "tournament.tournament_id": mongo.Types.ObjectId(result.tournament_id) }, { "prediction.game_id": mongo.Types.ObjectId(result._id), "prediction.winner": winner }],
          },
        },
        ...
        //Update all 2 point predictions
        {
          updateMany: {
            ...
            arrayFilters: [{ "tournament.tournament_id": mongo.Types.ObjectId(result.tournament_id) }, { "prediction.game_id": mongo.Types.ObjectId(result._id), "prediction.winner": winner, "prediction.score1": { $in: withinTenPointsTeam1 }, "prediction.score2": { $in: withinTenPointsTeam2 } }],
          },
        },
        ...
        //Update all 3 point predictions
        {
          updateMany: {
            ...
            arrayFilters: [{ "tournament.tournament_id": mongo.Types.ObjectId(result.tournament_id) }, { "prediction.game_id": mongo.Types.ObjectId(result._id), "prediction.winner": winner, "prediction.score1": { $in: withinFivePointsTeam1 }, "prediction.score2": { $in: withinFivePointsTeam2 } }],
          },
        },
      ]);
      ...
      const savePredictionPoints = await userCollection.bulkWrite([
        //Update all 2 point predictions
        {
          updateMany: {
            ...
            arrayFilters: [{ "tournament.tournament_id": mongo.Types.ObjectId(result.tournament_id) }, { "prediction.game_id": mongo.Types.ObjectId(result._id), "prediction.winner": winner, "prediction.difference": difference }],
          },
        },
        ...
        //Update all 3 point predictions
        {
          updateMany: {
            ...
            arrayFilters: [{ "tournament.tournament_id": mongo.Types.ObjectId(result.tournament_id) }, { "prediction.game_id": mongo.Types.ObjectId(result._id), "prediction.score1": result.score1, "prediction.score2": result.score2 }],
          },
        },
        ...
        //Update all 1 point predictions
        {
          updateMany: {
            ...
            arrayFilters: [{ "tournament.tournament_id": mongo.Types.ObjectId(result.tournament_id) }, { "prediction.game_id": mongo.Types.ObjectId(result._id), "prediction.winner": winner, "prediction.difference": { $ne: difference } }],
          },
        },
